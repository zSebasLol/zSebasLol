        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por ! zSnxb_#0001 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/958564580622237738/a_1fca1da1ac3be3c24d772eddc57df5d3.gif?size=2048` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`! zSnxb_#0001\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[! zSnxb_#0001](https://discord.gg/MBPsvcphGf)**`}], )
            .addFields([{name: `⏲ **__Llevo prendido__**`, value: `** \`${dias}\` dias \`${horas}\`Horas \`${minutos}\`Minutoss  y \`${segundos}\`Segundos **`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por ! zSnxb_#0001 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/958564580622237738/a_1fca1da1ac3be3c24d772eddc57df5d3.gif?size=2048` })
