...
module.exports = client => {
    console.log("CARGADO EL MÓDULO DE BIENVENIDAS".rainbow)
...
async function generar_bienvenida(member, data) {
    try {
        ...
        const attachment = new Discord.AttachmentBuilder(canvas.toBuffer(), `bienvenida-${member.user.username}.png`);
        return attachment;
    } catch (e) { console.log(e) }
}